...
namespace P2
{
	...
	// TODO (low): Use more unique way to generate GUIDs. See "CoCreateGuid"
	template<class T>
...
#	endif
	...
	/// It has affix P2 because otherwise it collides with winapi GetClassName
	template<class Type>
	constexpr std::string GetP2ClassName()
	{
