...
namespace P2
{
	class P2_API SimpleCallbackSink : public spdlog::sinks::base_sink<std::mutex>
	{
	public:
	...
	public:
		...
		inline static ConsoleLogger CreateOrGet(std::string name, spdlog::level::level_enum level = spdlog::level::info);
	...
	ConsoleLogger ConsoleLogger::CreateOrGet(std::string name, spdlog::level::level_enum level)
	{
